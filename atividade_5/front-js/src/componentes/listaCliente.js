...
export default function ListaCliente(props) {
    ...
    const fetchClients = async () => {
        await axios.get("http://localhost:3000/cliente/fetchall", {
...
export function VisualizarCliente(props) {
    ...
    const fetchClient = async () => {
        await axios.get(`http://localhost:3000/cliente/${props.client.id}/fetch`, {
            validateStatus: function(status) {
                return true
            }
        }).then((response) => {
        ...
        return (
            <div className="container-fluid">
                <table className="table">
                    ...
                    <tbody>
                        <tr style={{ backgroundColor: props.tema }}>
                            ...
                            <td>{selectedClient.nomeSocial}</td>
                            <td>({selectedClient.telefones[0].ddd}){selectedClient.telefones[0].numero}</td>
                        </tr>
                    </tbody>
                ...
                <table className="table">
                    ...
                    <tbody>
                        {selectedClient.produtosConsumidos.map((product, index) => (
                ...
                <table className="table">
                    <thead>
                        <tr>
                            <th scope="col">Serviços consumidos</th>
                       </tr>
                    </thead>
                    <tbody>
                        {selectedClient.servicosConsumidos.map((servico, index) => (    
                        <tr style={{ backgroundColor: props.tema }}>
                            <td>{servico.nome}</td>
                        </tr>
                        ))}
